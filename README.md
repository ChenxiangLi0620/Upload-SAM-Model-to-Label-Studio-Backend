...
When one starts labeling, toggle Auto Annotation on, and hit the check mark if one is happy with the auto segmentation and bounding box generated by the ML model.
