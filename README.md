...
When one starts labeling, toggle Auto Annotation on, select one of the tools (keypoints/bounding box/brush) and their relative label to annotate the image.
...
Hit the check mark if one is happy with the auto segmentation and bounding box generated by the ML model. Otherwise, press the cross mark and delete the keypoints/bounding box/brush one just added to the image, and do it again.
![image](https://github.com/ChenxiangLi0620/Upload-SAM-Model-to-Label-Studio-Backend/assets/168608052/f6d703d6-eee0-43b6-adf8-7517b79dde3d)
